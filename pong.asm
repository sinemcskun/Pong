STACK SEGMENT PARA STACK
	DB 64 DUP (' ')						 ;allocate program in segment 
STACK ENDS

DATA SEGMENT PARA 'DATA'				 ;variables in procedures
	
	WINDOW_WIDTH DW 140h                 ;the width of the window (320 pixels)
	WINDOW_HEIGHT DW 0C8h                ;the height of the window (200 pixels)      (used for window bounding)
...
;       Draw the points of the left player (player one)
		...
		LEA DX,TEXT_PLAYER_ONE_POINTS    ;give DX a pointer to the string TEXT_PLAYER_ONE_POINTS load effective address
